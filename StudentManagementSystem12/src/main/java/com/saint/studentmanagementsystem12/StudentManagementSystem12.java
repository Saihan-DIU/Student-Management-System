...
class Student extends Person {
    ...
    public List<String> getCourses() {
        return new ArrayList<>(courses); // Returning a copy to maintain encapsulation
    }

    public List<String> getGrades() {
        return new ArrayList<>(grades); // Returning a copy to maintain encapsulation
    }
...
// Class implementing the management system interface
